// =============================================================================
// pricing.js — variante CLASSIC SCRIPT (sem ) da fonte canônica
// supabase/functions/_shared/pricing.js
// =============================================================================
// Gerada mecanicamente com:
//   sed 's/^export //' supabase/functions/_shared/pricing.js > extensions/cotacao-rapida/shared/pricing.js
// Esta extensão não suporta ES modules (DT-01, ver sidebar.js) — carregada
// via <script src="shared/pricing.js"> clássico antes de sidebar.js, que
// consome calcDias/precoDiariaComSazonalidade/calcSubtotal como globais.
// tests/pricing-parity.test.js verifica que este arquivo é exatamente a
// fonte canônica com "export " removido — divergiu, o teste quebra.
// NÃO EDITE ESTE ARQUIVO DIRETAMENTE: edite a fonte canônica e regenere.
// =============================================================================
 ...
 */
function calcDias(retirada, devolucao) {
 ...
 * @returns {number} diárias (0 se período inválido)
 */
function calcDiasItem(retirada, devolucao, regraHoraExtra) {
 ...
 * @returns {number}
 */
function precoDiariaComSazonalidade(categoria, dataRetirada, sazonalidades) {
  if (dataRetirada) {
 ...
 * @returns {number}
 */
function calcSubtotal(tipoPreco, preco, quantidade, dias) {
